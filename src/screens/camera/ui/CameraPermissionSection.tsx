  ...
  return (
    <View className={`flex-row items-start ${containerStyle}`}>
      ...
      <View className="flex-1 ml-16">
        <Text className="text-text-secondary dark:text-dark-text-secondary font-semibold text-lg mb-2">
          {title}
        </Text>
        <Text className="text-text-tertiary dark:text-dark-text-secondary text-base leading-6">
          {description}
        </Text>
      </View>
    </View>
